...
namespace casadi {
  ...
  */
  ...
  public:
    ...
    // Print iteration
    void printIteration(ScpgenMemory* m, std::ostream &stream, s_t iter, double obj,
                        double pr_inf, double du_inf,
                        double reg, s_t ls_trials, bool ls_success) const;
    ...
    void line_search(ScpgenMemory* m, s_t& ls_iter, bool& ls_success) const;
    ...
    s_t res_x_, res_p_, res_g_lam_, res_p_lam_, res_p_d_;
    s_t res_f_, res_gl_, res_g_;

    // Modifier function io indices
    s_t mod_x_, mod_p_, mod_g_lam_;
    s_t mod_f_, mod_gl_, mod_g_;
    s_t mod_du_, mod_dlam_g_;
    ...
    struct Var {
      ...
      s_t res_var, res_lam, res_d, res_lam_d;
      s_t mod_var, mod_lam, mod_def, mod_defL;
      s_t exp_def, exp_defL;
    };
