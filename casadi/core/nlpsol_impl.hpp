...
namespace casadi {
  ...
  */
  ...
  public:
    ...
    std::string get_name_in(s_t i) override { return nlpsol_in(i);}
    std::string get_name_out(s_t i) override { return nlpsol_out(i);}
    /// @}
    ...
    double get_default_in(s_t ind) const override { return nlpsol_default_in(ind);}
