...
namespace casadi {
  ...
  */
  ...
  public:
    ...
    ///@{
    /// Add a new parameter
    MX add_p(const std::string& name=std::string(), s_t n=1);

    /// Add a new control
    MX add_u(const std::string& name=std::string(), s_t n=1);

    /// Add a new differential state
    MX add_x(const std::string& name=std::string(), s_t n=1);

    /// Add a implicit state
    std::pair<MX, MX> add_s(const std::string& name=std::string(), s_t n=1);

    /// Add a new algebraic variable
    MX add_z(const std::string& name=std::string(), s_t n=1);

    /// Add a new quadrature state
    MX add_q(const std::string& name=std::string(), s_t n=1);
    ...
    MX add_aux(const std::string& name=std::string(), s_t n=1);
  ...
  ///@}
    ...
    MX add_variable(const std::string& name, s_t n=1);
