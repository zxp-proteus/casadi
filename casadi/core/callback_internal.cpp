...
namespace casadi {
  ...
  Sparsity CallbackInternal::get_sparsity_in(s_t i) {
    TRY_CALL(get_sparsity_in, self_, i);
  }

  Sparsity CallbackInternal::get_sparsity_out(s_t i) {
    TRY_CALL(get_sparsity_out, self_, i);
  }

  std::string CallbackInternal::get_name_in(s_t i) {
    TRY_CALL(get_name_in, self_, i);
  }

  std::string CallbackInternal::get_name_out(s_t i) {
  ...
  bool CallbackInternal::has_forward(s_t nfwd) const {
  ...
  bool CallbackInternal::has_reverse(s_t nadj) const {
