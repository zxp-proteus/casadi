...
namespace casadi {
  ...
  Sparsity Conic::get_sparsity_in(s_t i) {
  ...
  Sparsity Conic::get_sparsity_out(s_t i) {
  ...
  double Conic::get_default_in(s_t ind) const {
    switch (ind) {
    case CONIC_LBX:
    case CONIC_LBA:
