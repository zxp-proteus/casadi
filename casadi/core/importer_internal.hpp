...
*/
  ...
  public:
    ...
    /** \brief Get entry as a text */
    std::string to_text(const std::string& cmd, s_t ind=-1) const;
    ...
    /// Meta data
    std::map<std::string, std::pair<s_t, std::string> > meta_;
