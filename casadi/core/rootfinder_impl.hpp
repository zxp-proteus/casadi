...
namespace casadi {
  ...
  public:
    ...
    Sparsity get_sparsity_in(s_t i) override { return oracle_.sparsity_in(i);}
    Sparsity get_sparsity_out(s_t i) override { return oracle_.sparsity_out(i);}
    /// @}

    ///@{
    /** \brief Names of function input and outputs */
    std::string get_name_in(s_t i) override { return oracle_.name_in(i);}
    std::string get_name_out(s_t i) override { return oracle_.name_out(i);}
    /// @}
