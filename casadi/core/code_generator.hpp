  ...
  */
  ...
  public:
    ...
    */
    ...
    s_t add_sparsity(const Sparsity& sp);

    /** \brief Get the index of an existing sparsity pattern */
    s_t get_sparsity(const Sparsity& sp) const;

    /** \brief Get or add a constant */
    s_t get_constant(const std::vector<double>& v, bool allow_adding=false);

    /** \brief Get or add an integer constant */
    s_t get_constant(const std::vector<s_t>& v, bool allow_adding=false);

    /** \brief Represent an array constant; adding it when new */
    std::string constant(const std::vector<s_t>& v);
    ...
    static std::string initializer(const std::vector<s_t>& v);
    ...
    std::string dot(s_t n, const std::string& x, const std::string& y);
    ...
    std::string mv(const std::string& x, s_t nrow_x, s_t ncol_x,
                   const std::string& y, const std::string& z, bool tr);

    /** \brief Codegen axpy: y += a*x */
    std::string axpy(s_t n, const std::string& a,
                     const std::string& x, const std::string& y);

    /** \brief Codegen axpy: x *= alpha */
    std::string scal(s_t n, const std::string& alpha, const std::string& x);
    ...
    std::string interpn(const std::string& res, s_t ndim, const std::string& grid,
                        const std::string& offset,
                        const std::string& values, const std::string& x,
                        const std::string& lookup_mode, s_t m,
    ...
    std::string interpn_grad(const std::string& grad,
      s_t ndim, const std::string& grid,
      const std::string& offset,
      const std::string& values, const std::string& x,
      const std::string& lookup_mode, s_t m,
      const std::string& iw, const std::string& w);
    ...
    /** \brief QR solve */
    std::string qr_solve(const std::string& x, s_t nrhs, bool tr,
                         const std::string& sp_v, const std::string& v,
                         const std::string& sp_r, const std::string& r,
    ...
    std::string work(s_t n, s_t sz) const;

    /** Get work vector element from index */
    std::string workel(s_t n) const;

    /** Declare an array */
    static std::string array(const std::string& type, const std::string& name, s_t len,
                             const std::string& def=std::string());

    /** \brief  Print s_t vector to a c file */
    static void print_vector(std::ostream &s, const std::string& name,
                             const std::vector<s_t>& v);
