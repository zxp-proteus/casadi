...
namespace casadi {
  ...
  /** \brief Generic data type, can hold different types such as bool, s_t, string etc.
  ...
  */
  ...
  public:
    ...
    GenericType(const std::vector<s_t>& iv);
    GenericType(const std::vector< std::vector<s_t> >& ivv);
    ...
    operator s_t() const { return to_int();}
    operator double() const { return to_double();}
    operator std::string() const { return to_string();}
    operator std::vector<bool>() const { return to_bool_vector();}
    operator std::vector<s_t>() const { return to_int_vector();}
    operator std::vector<int>() const { return to_int_type_vector();}
    operator std::vector<std::vector<s_t> >() const { return to_int_vector_vector();}
    ...
    const s_t& as_int() const;
    const double& as_double() const;
    const std::string& as_string() const;
    const std::vector<s_t>& as_int_vector() const;
    const std::vector<s_t>& as_bool_vector() const;
    const std::vector<std::vector<s_t> >& as_int_vector_vector() const;
    ...
    std::vector<s_t> to_int_vector() const;
    std::vector<bool> to_bool_vector() const;
    std::vector< std::vector<s_t> > to_int_vector_vector() const;
