...
namespace casadi {
  ...
  class CASADI_NLPSOLVER_BONMIN_EXPORT BonminUserClass : public TMINLP {
#ifdef WITH_BONMIN_CALLBACK
    friend class TNLPAdapter;
#endif // WITH_BONMIN_CALLBACK

  public:
    BonminUserClass(BonminInterface* bonminInterface);
