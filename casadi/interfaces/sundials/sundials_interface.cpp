...
namespace casadi {
  ...
  Dict SundialsInterface::get_stats(void* mem) const {
    ...
    stats["nsteps"] = static_cast<s_t>(m->nsteps);
    stats["nfevals"] = static_cast<s_t>(m->nfevals);
    stats["nlinsetups"] = static_cast<s_t>(m->nlinsetups);
    stats["netfails"] = static_cast<s_t>(m->netfails);
    stats["qlast"] = m->qlast;
    stats["qcur"] = m->qcur;
    ...
    stats["hcur"] = m->hcur;
    stats["tcur"] = m->tcur;
    stats["nniters"] = static_cast<s_t>(m->nniters);
    stats["nncfails"] = static_cast<s_t>(m->nncfails);

    // Counters, backward problem
    stats["nstepsB"] = static_cast<s_t>(m->nstepsB);
    stats["nfevalsB"] = static_cast<s_t>(m->nfevalsB);
    stats["nlinsetupsB"] = static_cast<s_t>(m->nlinsetupsB);
    stats["netfailsB"] = static_cast<s_t>(m->netfailsB);
    ...
    stats["hcurB"] = m->hcurB;
    stats["tcurB"] = m->tcurB;
    stats["nnitersB"] = static_cast<s_t>(m->nnitersB);
    stats["nncfailsB"] = static_cast<s_t>(m->nncfailsB);
    return stats;
  }
